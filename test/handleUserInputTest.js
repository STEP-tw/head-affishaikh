...
describe('extractUserInput', function() {
  it.only('should return an object of 1 filepath and 10 numberOfLines when given only one file', function() {
  ...
  it.only('should return an object of 1 filepath and 5 numberOfLines when given only one file and -n5', function() {
